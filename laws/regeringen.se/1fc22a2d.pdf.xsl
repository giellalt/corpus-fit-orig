...
<xsl:variable name="filename" select="'http://www.regeringen.se/content/1/c6/13/75/75/1fc22a2d.pdf'"/>
...
<xsl:variable name="note" select="'Main url: http://www.regeringen.se/sb/d/108/a/137575'"/>
